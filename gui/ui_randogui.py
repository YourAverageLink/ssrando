...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_43.addWidget(self.label_for_option_chest_dowsing)
        ...
        self.verticalLayout_43.addWidget(self.option_chest_dowsing)
        ...
        self.verticalLayout_41.addWidget(self.option_dungeon_dowsing)
